...
description: "Manage your AI for Work account, workspaces, and the Admin Console centralized management interface."
---
...
<Steps>
  <Step title="Log in">
    Log in to [AI for Work](https://work.kore.ai/login/).
  </Step>
  <Step title="Open the Admin Console">
    Click **Admin Console** from your user account menu. The system redirects to the **Workspace** page.
  </Step>
</Steps>
...
<Steps>
  <Step title="Navigate to workspace management">
...
**Available agent types for personal workspaces:**
